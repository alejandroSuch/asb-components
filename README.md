asb-components - [AngularJS](http://angularjs.org/) set of utilities [![Build Status](https://travis-ci.org/alejandroSuch/asb-components.svg?branch=master)](https://travis-ci.org/alejandroSuch/asb-components)
